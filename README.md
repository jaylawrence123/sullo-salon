...
| # | Section | Status |
|---|---------|--------|
| 1 | Hero (announce bar + nav + video + wordmark + pink pill + sticky bar) | Done |
...
| 9 | Final CTA (square photo, copy only — no CTAs, flows into pink nudge) | Done |
| 10 | Footer (pink nudge = sole CTA + ink body + socials + legal) | Done |
...
- **Hero fallback image:** One placeholder remains — warm editorial, vertical crop, stylist at work
...
pink       #EF87AA   brand pink — accent only
pink-soft  #F2A4BD   pills, bar, nudge strip
